...
**آخر تحديث للملف ده:** 2026-08-27

**الحالة دلوقتي:** 30 ولاية · 50 مدينة · 2 شيك ليست — إجمالي 1307 حقل.

| الحالة | العدد | معناها في الواجهة |
|---|---|---|
| `verified` | 18 | من غير بادج، المصدر في الفوتنوت |
| `estimated` | 517 | بادج "تقديري"، والbasis في tooltip |
...
⚠️ **35 لينك لسه ماتفتحوش ولا مرة.** اتكتبوا من معرفة عامة والشبكة على جهاز البناء بتحجب المواقع الخارجية (بترجع 403 حتى لـ`travel.state.gov`)، فماتأكدناش إنهم شغالين.

افتحهم واحد واحد، صلّح اللي اتغير، وبعدين حط تاريخ النهاردة في `linksLastChecked` في `content/resources.json`.
